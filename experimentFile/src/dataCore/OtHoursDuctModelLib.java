            ...
            try {
                ...
                while (rs02.next()) {
                    ...
                    if ((rs02.getString(4) != null) && rs02.getString(1) != null) {
                        ...
                        System.out.println("Main Duration Hours: " + durationHours + "OutTime: " + outTimeHours);
                        ...
                        continue; // if cardno and outime is not valid then continue next step
                    }
                }
            } finally {
