 ...
 * @author anik
 */
public class ShowAllRoomBookingList extends javax.swing.JFrame {

    private RoombookingService roombookingService;
    /**
     * Creates new form ShowAllBookInformation
     */
    public ShowAllRoomBookingList() {
        this.setTitle("Show Room Booking List ( Hospital Management System  )");
        initComponents();
    ...
    private void initComponents() {
        ...
        tblDisplayBookInfo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Doctor ID", "Description"
            }
        ));
        ...
        jLabel1.setText(">> Show All Room Booking List");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     ...
     private void displayInformationWithInTable() {
        ...
        List<RoomInfoBooking> getinformation = roombookingService.getDataFromPatientTable();
        ...
        for (int i = 0; i < getinformation.size(); i++) {
            ...
            row[0] = getinformation.get(i).getPatientId();
            row[1] = getinformation.get(i).getDoctorId();
            row[2] = getinformation.get(i).getDescription();
            model.addRow(row);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAllRoomBookingList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
