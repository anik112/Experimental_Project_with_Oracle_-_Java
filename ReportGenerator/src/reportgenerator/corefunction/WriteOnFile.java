...
public class WriteOnFile {
    ...
    public static void main(String[] arg) {
        ...
        new WriteOnFile().writeTextInPdfFile();
    }

    public void writeTextInPdfFile() {
        ...
        try {
            ...
            Image topLogo = Image.getInstance("D:\\\\logoVSI.png");
            topLogo.setAlignment(topLogo.ALIGN_RIGHT);
            topLogo.scaleAbsolute(150, 50);
            //topLogo.setSpacingBefore(100);
            document.add(topLogo);
            
            
            Font f1 = FontFactory.getFont("SansSerif", 12);
            ...
            Font f2=FontFactory.getFont("SansSerif", 12);
            ...
            Logger.getLogger(WriteOnFile.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
